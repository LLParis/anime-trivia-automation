...
- **Confidence gates are floors, not walls.** Gemini/Antigravity accept medium confidence (`min_confidence` 0.35); local Qwen accepts 0.45. The old 0.72/0.90 thresholds plus a second verifier pass produced `UNKNOWN` on every novel clue.
